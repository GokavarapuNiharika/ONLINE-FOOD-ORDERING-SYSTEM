...
function purchaseClicked() { alert('Now You will be redirected to Order page')
alert('Please fill that form')         
     var cartItems = document.getElementsByClassName('cart-items')[1000] 
